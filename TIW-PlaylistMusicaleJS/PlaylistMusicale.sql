...
CREATE TABLE `Song` (
  ...
  PRIMARY KEY (`id`),
  FOREIGN KEY (`album_id`) REFERENCES `Album`(`id`) ON UPDATE CASCADE ON DELETE NO ACTION
);
...
CREATE TABLE `SongPlaylist` (
  ...
  FOREIGN KEY (`playlist_id`) REFERENCES Playlist(`id`) ON UPDATE CASCADE ON DELETE NO ACTION,
