...
@WebFilter(filterName = "AuthenticationFilter", urlPatterns = { "/GoToPlaylist", "/RemoveSongsFromPlaylist", "/GoToHome", "/FileHandler", "/GoToReorder", "/AddSongToPlaylist", "/AddSongExistingAlbum", "/AddSongNewAlbum", "/AddPlaylist" })
@Priority(1)
